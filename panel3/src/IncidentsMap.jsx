...
const INCIDENTS = [
  { id: "#A-2847", category: "Skażenie chemiczne", gmina: "Lublin",            level: "alarm",    title: "Skażenie chemiczne — ul. Mełgiewska", time: "14:07", date: "20.05.2026", mAgo: 8,    op: "D. Nowak" },
  { id: "#A-2846", category: "Naruszenie granicy",  gmina: "Hrubieszów",        level: "critical", title: "Naruszenie granicy państwa",          time: "13:42", date: "20.05.2026", mAgo: 33,   op: "System (AI)" },
  { id: "#A-2845", category: "Awaria przemysłowa",  gmina: "Puławy",            level: "warn",     title: "Awaria w zakładach azotowych",        time: "12:18", date: "20.05.2026", mAgo: 117,  op: "M. Kowalska" },
  { id: "#A-2844", category: "Powódź",              gmina: "Chełm",             level: "warn",     title: "Podtopienia — rzeka Uherka",          time: "11:55", date: "20.05.2026", mAgo: 140,  op: "System (AI)" },
  { id: "#A-2843", category: "Aktywność wojskowa",  gmina: "Włodawa",           level: "watch",    title: "Wzmożony ruch pojazdów wojskowych",   time: "11:12", date: "20.05.2026", mAgo: 183,  op: "J. Marek" },
  { id: "#A-2842", category: "Burza",               gmina: "Zamość",            level: "watch",    title: "Burza z gradem — ostrzeżenie IMGW",   time: "10:30", date: "20.05.2026", mAgo: 225,  op: "System (AI)" },
  { id: "#A-2841", category: "Pożar",               gmina: "Tomaszów Lubelski", level: "watch",    title: "Pożar lasu — Roztocze",               time: "09:14", date: "20.05.2026", mAgo: 301,  op: "K. Wójcik" },
  { id: "#A-2838", category: "Wypadek drogowy",     gmina: "Janów Lubelski",    level: "warn",     title: "Wyciek paliwa — droga 19",             time: "22:14", date: "19.05.2026", mAgo: 960,  op: "P. Lis" },

  // ───── Wildfire sequence (last 72 h, east → west) ─────
  // One propagating fire front. Older mAgo = more eastern "source";
  // newest mAgo = current front on the western edge of Lubelskie.
  // Severity escalates over time — cooled spots stay as warn,
  // active middle as alarm, leading edge as critical.
  { id: "#F-001", category: "Pożar", gmina: "Mircze",          level: "warn",     title: "Pożar lasu — źródło (strefa A1)",            time: "16:15", date: "17.05.2026", mAgo: 4200, op: "PSP Hrubieszów",  pos: [50.78, 23.90] },
  { id: "#F-002", category: "Pożar", gmina: "Białopole",       level: "warn",     title: "Pożar lasu — front +12 km W (strefa A2)",   time: "12:15", date: "18.05.2026", mAgo: 3000, op: "PSP Hrubieszów",  pos: [50.95, 23.55] },
  { id: "#F-003", category: "Pożar", gmina: "Krasnystaw",      level: "alarm",    title: "Pożar lasu — linia ognia 8 km (strefa A3)",  time: "22:15", date: "18.05.2026", mAgo: 2400, op: "PSP Krasnystaw", pos: [51.05, 23.18] },
  { id: "#F-004", category: "Pożar", gmina: "Łęczna",           level: "alarm",    title: "Pożar lasu — ewakuacja sołectw (strefa A4)", time: "16:35", date: "19.05.2026", mAgo: 1300, op: "PSP Łęczna",     pos: [51.18, 22.78] },
  { id: "#F-005", category: "Pożar", gmina: "Niemce",          level: "critical", title: "Pożar lasu — zagrożenie Lublina (A5)",      time: "04:15", date: "20.05.2026", mAgo: 600,  op: "PSP Lublin",     pos: [51.22, 22.40] },
  { id: "#F-006", category: "Pożar", gmina: "Opole Lubelskie", level: "critical", title: "Pożar lasu — ewakuacja Poniatowej (A6)",    time: "10:55", date: "20.05.2026", mAgo: 200,  op: "PSP Opole Lub.", pos: [51.14, 22.00] },
  { id: "#F-007", category: "Pożar", gmina: "Annopol",         level: "critical", title: "Pożar lasu — aktywny front (Wisła, A7)",     time: "13:45", date: "20.05.2026", mAgo: 30,   op: "PSP Kraśnik",    pos: [51.05, 21.70] },
];
...
function IncidentsMap() {
  ...
  // Show/hide the right tier whenever zoom changes (or after layers build).
  React.useEffect(() => {
    const map = mapRef.current;
    if (!map) return;
    ...
    setOn(powiatyLabels, t === "powiat");
    setOn(gminy,         t === "gmina");
    setOn(gminyLabels,   t === "gmina");
  ...
  const byRange = INCIDENTS.filter(i => i.mAgo <= rangeMinutes);
      ...
      <TopBar
        ...
        titleMeta={
          <>
            ...
            <span className="page-title-tag tier-tag">
      ...
      <div className="content">
        ...
        <div className={labelClass} data-tier={tier}>
          ...
          <div className={"map-overlay map-list" + (listOpen ? "" : " is-collapsed")}>
            <div className="map-list-head">
              <div className="map-overlay-eyebrow">
                Aktywne incydenty <span className="map-list-count">· {visibleIncidents.length}</span>
              </div>
              <button
          ...
          >
            ...
            <span>Incydenty</span>
            <span className="map-list-open-pill">{visibleIncidents.length}</span>
          </button>
        </div>
        </div>
      </div>
